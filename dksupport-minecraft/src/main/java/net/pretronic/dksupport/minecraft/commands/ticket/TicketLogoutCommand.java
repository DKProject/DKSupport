...
public class TicketLogoutCommand extends BasicCommand {

    public TicketLogoutCommand(ObjectOwner owner) {
        super(owner, CommandConfiguration.newBuilder().name("logout").permission(DKSupportConfig.PERMISSION_STAFF).create());
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        CommandUtil.changeLogin(PlayerSettingsKey.SUPPORT,player,current,false);
    }
}
