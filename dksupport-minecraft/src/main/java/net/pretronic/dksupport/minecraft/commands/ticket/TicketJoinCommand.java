...
public class TicketJoinCommand extends BasicCommand {

    private DKSupport dksupport;

    public TicketJoinCommand(ObjectOwner owner) {
        super(owner, CommandConfiguration.newBuilder().name("join").permission(DKSupportConfig.PERMISSION_STAFF).create());
    }
